...
s_id = { 1: [1, 2, 3, 4] , 2 : [9, 10, 11, 12], 3 : [5, 6, 7, 8], 4 : [13, 14, 15, 16] } # SEQUENCES TO ORDER REFERENCE POINTS
#----------------------------------------------------------------------------------------------------------------------------------------------CLASS
#||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||||| 
...
if __name__ == "__main__":
    ...
    parser.add_argument('-s', '--side_virtual',              type=int, default=12000,  help='bird visible área, lenght for each side (mm)')
