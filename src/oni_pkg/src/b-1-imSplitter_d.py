...
if __name__ == '__main__':
    ...
    try:
        ...
        s   = rospy.Subscriber('/dIm', Image, sp) 
        
        pl = rospy.Publisher('/dIm_l', Image, queue_size=0.00005) 
        pr = rospy.Publisher('/dIm_r', Image, queue_size=0.00005) 
        pf = rospy.Publisher('/dIm_f', Image, queue_size=0.00005) 
        pb = rospy.Publisher('/dIm_b', Image, queue_size=0.00005) 
