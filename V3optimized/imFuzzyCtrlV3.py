...
if __name__ == '__main__':
    ...
    try:
        ...
        pfc = rospy.Publisher('/fCtrl', fuzzy_corr, queue_size=0.0005)  #(PUBLISHER OF FUZZY CONTROL) #8 -- INITIALIZE PUBLISHER TO RETURN THE CONTROL CORRECTIONS
         
        syn = message_filters.ApproximateTimeSynchronizer([sl, sr, sf, sst ], queue_size=1, slop=0.0005) #7 SYNC RETRIEVED DATA      
